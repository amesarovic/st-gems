...
class ST_GeomFromText(MacroSpec):
    name: str = "ST_GeomFromText"
    projectName: str = "andre_st_gems"
    category: str = "ST_Spatial"


    @dataclass(frozen=True)
    class ST_GeomFromTextProperties(MacroProperties):
    ...
    def apply(self, props: ST_GeomFromTextProperties) -> str:
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return ST_GeomFromText.ST_GeomFromTextProperties(
