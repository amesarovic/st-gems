...
class ST_Envelope(MacroSpec):
    name: str = "ST_Envelope"
    projectName: str = "andre_st_gems"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class ST_EnvelopeProperties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        ...
        return Dialog("ST_Envelope").addElement(
    ...
    def apply(self, props: ST_EnvelopeProperties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return ST_Envelope.ST_EnvelopeProperties(
