...
class ST_Buffer(MacroSpec):
    ...
    class ST_BufferProperties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        ...
        return Dialog("ST_Buffer").addElement(
    ...
    def apply(self, props: ST_BufferProperties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return ST_Buffer.ST_BufferProperties(
